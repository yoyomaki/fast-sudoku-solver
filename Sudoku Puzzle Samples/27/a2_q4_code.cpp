...
struct cell{
    ...
    int h;                             //Least Constraining Value heuristic
...
//Most Constraining Variable heuristic tie breaker
...
//caculate Least Constraining Value heuristic
...
//first, use Most Restricted Variable heuristic to find a unassigned position
//second, use Least Constraining Value heuristic to order children
...
//return true if value is valid in position puzzle[r][c]
...
//for back_tracking usage
//insert assigned values to unassigned_pos if they are valid
...
//after an assignment, call unassigned_update
//update remainging variables if they are constrainted by puzzle[r][c]
